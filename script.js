...
// const introText = "Here's What Happens If You Only Ate Maggie For 30 Days";
const introText='';
const bg = '';
const imageArray = [
    '1.png',
...
function positionObserver() {
    const images = Array.from(document.getElementsByClassName('single-image'));
    setInterval(() => {
